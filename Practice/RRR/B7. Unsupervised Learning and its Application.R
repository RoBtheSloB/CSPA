###################################################################
## B7. Unsupervised Learning and its Application
###################################################################
## Libraries
library(tidyverse)
library(ISLR2)
...
# Matrix completion - feels less important (should likely skip)
...
## NCI60 Data Example
nci.labs <- ISLR2::NCI60$labs
nci.data <- ISLR2::NCI60$data
...
plot(pve ,type = "o" ,ylab = "PVE" ,xlab = "Principal Components"
     ,col = "blue")
